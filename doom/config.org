...
(defun jecs/apply-frame-size-smart (&optional frame)
  (let* ((frame (or frame (selected-frame)))
         ...
         (want-width  (* jecs/default-frame-cols (frame-char-width frame)))
         (want-height (* jecs/default-frame-rows (frame-char-height frame))))
    (if (or (> want-width wa-width)
            (> want-height wa-height))
        (progn
          (set-frame-position
           frame
           (+ wa-left jecs/small-display-margin-left)
           (+ wa-top jecs/small-display-margin-top))
          (set-frame-size
           frame
           (- wa-width
              jecs/small-display-margin-left
              jecs/small-display-margin-right)
           (- wa-height
              jecs/small-display-margin-top
