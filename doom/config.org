...
(map!
 :desc "New Emacs Instance" :g "C-c o e" #'restart-emacs-start-new-emacs
 :desc "Open Calculator" :g "C-c o c" #'calc
 :desc "Open Calendar" :g "C-c o k" #'calendar)

(set-frame-parameter nil 'alpha-background 98)
(add-to-list 'default-frame-alist '(alpha-background . 98))

(add-hook! term-mode-hook (display-line-numbers-mode 0))
(add-hook! vterm-mode-hook (display-line-numbers-mode 0))
(add-hook! shell-mode-hook (display-line-numbers-mode 0))
(add-hook! treemacs-mode-hook (display-line-numbers-mode 0))
(add-hook! eshell-mode-hook (display-line-numbers-mode 0))
#+end_src
...
#+begin_src emacs-lisp :tangle yes
(use-package! slack
  :commands (slack-start slack-stop)
  :init
  (map! :prefix ("C-z" . "Slack")
        ...
        :desc "Reply in thread"  "t" #'slack-thread-show-or-create
